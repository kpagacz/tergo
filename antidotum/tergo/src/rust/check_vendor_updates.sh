...
find ./vendor/ -name '.cargo-checksum.json' -exec md5sum {} + | sort -k 2 | cut -d" " -f1 >downloaded
find ./repo_vendor/vendor/ -name '.cargo-checksum.json' -exec md5sum {} + | sort -k 2 | cut -d" " -f1 >in_repo
